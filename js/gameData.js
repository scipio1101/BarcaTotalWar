...
const cities = [
    // 西班牙- 伊比利亚半岛
    { id: 'gades', name: '迦得斯', faction: 'carthage', important: false, x: 50, y: 390, 
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 40 },
    { id: 'emerita', name: '艾梅里达', faction: 'neutral', important: false, x: 70, y: 360,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'asturica', name: '阿斯图里加', faction: 'neutral', important: false, x: 80, y: 320,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'corduba', name: '科尔巴多', faction: 'carthage', important: false, x: 90, y: 380,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    { id: 'toletum', name: '托莱图姆', faction: 'neutral', important: false, x: 110, y: 350,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'newcarthage', name: '新迦太基', faction: 'carthage', important: true, x: 130, y: 360,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 50, economicScore: 50, fortificationLevel: 1 },
    { id: 'sagunto', name: '萨贡托', faction: 'rome', important: false, x: 150, y: 330,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    { id: 'bilibilis', name: '比比里斯', faction: 'neutral', important: false, x: 140, y: 310,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 10 },
    { id: 'budilragus', name: '布迪拉格', faction: 'neutral', important: false, x: 160, y: 260,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 10 },
    { id: 'taraco', name: '塔拉科', faction: 'neutral', important: false, x: 170, y: 290,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    
    // 高卢南部和北意大利
    { id: 'narbo', name: '纳博讷', faction: 'neutral', important: false, x: 190, y: 230,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    { id: 'massalia', name: '马赛', faction: 'neutral', important: false, x: 220, y: 200,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 40 },
    { id: 'lugdunum', name: '卢格杜努姆', faction: 'neutral', important: false, x: 200, y: 150,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    { id: 'cenabum', name: '凯纳布姆', faction: 'neutral', important: false, x: 180, y: 120,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'treveri', name: '特雷维里', faction: 'neutral', important: false, x: 210, y: 100,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'mediolanum', name: '梅迪奥拉努姆', faction: 'rome', important: false, x: 270, y: 170,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 40 },
    { id: 'placentia', name: '普拉森提亚', faction: 'rome', important: false, x: 280, y: 190,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    { id: 'aquileia', name: '阿奎莱亚', faction: 'neutral', important: false, x: 330, y: 180,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    { id: 'salona', name: '萨洛纳', faction: 'neutral', important: false, x: 380, y: 220,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    { id: 'sirmium', name: '西尔米乌姆', faction: 'neutral', important: false, x: 420, y: 200,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'serdica', name: '赛尔迪卡', faction: 'neutral', important: false, x: 480, y: 240,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    
    // 意大利半岛
    { id: 'rome', name: '罗马', faction: 'rome', important: true, x: 330, y: 290,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 50, economicScore: 50, fortificationLevel: 1 },
    { id: 'casilinum', name: '阿斯库路姆', faction: 'rome', important: false, x: 340, y: 310,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'pisatum', name: '彭锡图', faction: 'rome', important: false, x: 370, y: 320,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'capua', name: '卡普阿', faction: 'rome', important: true, x: 350, y: 330,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 50, economicScore: 40, fortificationLevel: 1 },
    { id: 'brundisium', name: '布林迪西', faction: 'rome', important: false, x: 410, y: 350,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    { id: 'rhegium', name: '里吉乌姆', faction: 'rome', important: false, x: 360, y: 380,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'tarentum', name: '墨西拿', faction: 'rome', important: false, x: 390, y: 360,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    
    // 西西里岛
    { id: 'lilybaeum', name: '莉莉巴厄姆', faction: 'rome', important: false, x: 300, y: 400,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    { id: 'syracuse', name: '叙拉古', faction: 'neutral', important: true, x: 370, y: 420,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 50, economicScore: 50, fortificationLevel: 1 },
    
    // 北非
    { id: 'tingis', name: '廷吉斯', faction: 'carthage', important: false, x: 120, y: 480,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'sicca', name: '锡卡', faction: 'carthage', important: false, x: 190, y: 450,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'zella', name: '赛拉', faction: 'carthage', important: false, x: 170, y: 470,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 10 },
    { id: 'cirta', name: '艾奥姆尼姆', faction: 'carthage', important: false, x: 230, y: 440,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'utica', name: '乌提卡', faction: 'carthage', important: false, x: 290, y: 430,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    { id: 'carthage', name: '迦太基', faction: 'carthage', important: true, x: 310, y: 440,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 50, economicScore: 50, fortificationLevel: 1 },
    { id: 'tacape', name: '塔卡佩', faction: 'carthage', important: false, x: 320, y: 480,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'thubactus', name: '图巴克图斯', faction: 'carthage', important: false, x: 350, y: 500,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 10 },
    { id: 'cyrenaica', name: '昔兰尼', faction: 'carthage', important: false, x: 420, y: 510,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    { id: 'hadrumetum', name: '巴迪亚斯', faction: 'carthage', important: false, x: 340, y: 460,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    
    // 亚得里亚海东
    { id: 'pharos', name: '拉文纳', faction: 'rome', important: false, x: 410, y: 270,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    { id: 'bononia', name: '博纳尼亚', faction: 'rome', important: false, x: 370, y: 210,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    { id: 'pisa', name: '比萨', faction: 'rome', important: false, x: 300, y: 240,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    
    // 希腊半岛和马其顿
    { id: 'corinth', name: '科林斯', faction: 'macedonia', important: false, x: 480, y: 350,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 40 },
    { id: 'athens', name: '雅典', faction: 'macedonia', important: true, x: 450, y: 330,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 50, economicScore: 70, fortificationLevel: 1 },
    { id: 'sparta', name: '斯巴达', faction: 'macedonia', important: false, x: 510, y: 370,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'pella', name: '佩拉', faction: 'macedonia', important: true, x: 530, y: 290,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 50, economicScore: 40, fortificationLevel: 1 },
    { id: 'demetrias', name: '安布拉基亚', faction: 'macedonia', important: false, x: 540, y: 320,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'philippopolis', name: '迪拉奇乌姆', faction: 'macedonia', important: false, x: 420, y: 310,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    
    // 色雷斯和小亚细亚
    { id: 'aelos', name: '艾洛斯', faction: 'neutral', important: false, x: 590, y: 280,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'byzantium', name: '拜占庭', faction: 'neutral', important: false, x: 650, y: 260,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 40 },
    { id: 'nicomedia', name: '尼科米底亚', faction: 'neutral', important: false, x: 680, y: 280,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    { id: 'ancyra', name: '安卡拉', faction: 'seleucid', important: false, x: 720, y: 300,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 1, economicScore: 20 },
    { id: 'sinope', name: '锡洛普', faction: 'neutral', important: false, x: 720, y: 240,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    { id: 'pergamon', name: '帕伽玛', faction: 'neutral', important: false, x: 630, y: 320,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 40 },
    { id: 'ephesos', name: '以弗所', faction: 'neutral', important: false, x: 650, y: 350,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 40 },
    { id: 'crete', name: '克里特', faction: 'neutral', important: false, x: 550, y: 400,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 40 },
    { id: 'perga', name: '佩尔加', faction: 'neutral', important: false, x: 680, y: 390,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'appia', name: '阿皮亚', faction: 'neutral', important: false, x: 700, y: 340,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'tarsus', name: '塔苏斯', faction: 'seleucid', important: false, x: 710, y: 420,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 1, economicScore: 30 },
    { id: 'caesarea', name: '欧塞比亚', faction: 'neutral', important: false, x: 750, y: 320,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 20 },
    { id: 'antioch', name: '安条克', faction: 'seleucid', important: true, x: 730, y: 460,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 3, economicScore: 50, fortificationLevel: 1 },
    { id: 'damascus', name: '大马士革', faction: 'seleucid', important: false, x: 750, y: 490,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 1, economicScore: 40 },
    { id: 'jerusalem', name: '耶路撒冷', faction: 'seleucid', important: false, x: 720, y: 520,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 10, economicScore: 30 },
    { id: 'pelusium', name: '贝鲁西亚', faction: 'ptolemy', important: false, x: 680, y: 520,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 1, economicScore: 20 },
    
    // 埃及和利比亚边界
    { id: 'katabathmus', name: '卡塔巴特姆斯', faction: 'ptolemy', important: false, x: 580, y: 500,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 1, economicScore: 10 },
    
    // 埃及
    { id: 'alexandria', name: '亚历山大', faction: 'ptolemy', important: true, x: 730, y: 470,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 3, economicScore: 75, fortificationLevel: 1 },
    { id: 'memphis', name: '孟菲斯', faction: 'ptolemy', important: false, x: 750, y: 490,
      isUnderSiege: false, siegeCount: 0, besiegingFaction: null, politicalScore: 1, economicScore: 40 }
];
